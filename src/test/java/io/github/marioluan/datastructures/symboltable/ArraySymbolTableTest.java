...
public class ArraySymbolTableTest {
    ...
    private ArraySymbolTable<Integer, Integer> subject;
    private static final Random                RANDOM = new Random();
    private Integer                            key;
    private Integer                            value;

    {
        describe("ArraySymbolTable", () -> {
            beforeEach(() -> {
                this.subject = new ArraySymbolTable<>(1);
                this.key = Integer.valueOf(RANDOM.nextInt(26 + 'a'));
            ...
            describe("#keys", () -> {
                ...
                describe("when table is not empty", () -> {
                    it("returns the keys from the table", () -> {
                        ...
                        for (Integer k : this.subject.keys())
